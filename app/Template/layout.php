...
<html>
    <head>
        ...
        <?= $this->asset->css('assets/css/acc.css') ?>
        <?= $this->asset->customCss() ?>

        <?php if (! isset($not_editable)): ?>
            <?= $this->asset->js('assets/js/vendor.min.js') ?>
            <?= $this->asset->js('assets/js/app.min.js') ?>
            <?= $this->asset->js('assets/js/particles.min.js') ?>
            <?= $this->asset->js('assets/js/doublescroll.js') ?>
        <?php endif ?>

        <?= $this->hook->asset('css', 'template:layout:css') ?>
        <?= $this->hook->asset('js', 'template:layout:js') ?>

        <link rel="icon" type="image/png" href="<?= $this->url->dir() ?>assets/img/acc.ico">
    ...
    >
    <div id="particles-js" style="position: fixed;width: 100%;height: 100%;z-index: -1; /*margin-top: -69px;*/"></div>
    ...
    <?php else: ?>
        ...
        <div class="footer">made with <span class="love">♥</span> in fatmawati.</div>
    <?php endif ?>

    <?php if (! isset($not_editable)): ?>
        <?= $this->asset->js('assets/js/proment.js') ?>
    <?php endif ?>
    </body>
</html>
