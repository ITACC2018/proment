...
<div class="form-login">
    <div class="login content">
        <img src="assets/img/acc.jpg" style="width: 66px;height: 56px;"></img>
        <h1 style="color: #0062f8cf;font-size: 3.0em;font-family: fantasy;margin-left: 15px;position: absolute;">PROMENT</h1>
    </div>
