...
return array(
    ...
    'Average time spent into each column' => '每个任务栏的平均花费时间',
    ...
    'Cycle Time' => '周期时间',
    'Lead Time' => '工作时间',
    'This chart show the average lead and cycle time for the last %d tasks over the time.' => '该图表显示了过去 %d 个任务的平均和峰值耗时。',
    ...
    'Unfortunately, we are unable to reset your password. Did you entered a valid username? Do you have an email address in your profile?' => '抱歉，无法重置你的密码。请确认输入正确的用户名或email地址？',
